...
pub use stoq::transport::certificates::{
    CertificateConfig, CertificateManager, CertificateMode, StoqNodeCertificate, TrustChainClient,
};

// For backward compatibility, provide a simple factory function
pub async fn create_certificate_manager(
    config: CertificateConfig,
) -> anyhow::Result<CertificateManager> {
