                ...
                AssetInfo {
                    ...
                    matrix_shards: vec![
                        ...
                        MatrixShard {
                            ...
                            position: MatrixPosition { x: 15, y: 20, z: 0 },
                            size_bytes: 1048576,
                            redundancy_level: 3,
                        },
                    ],
                ...
                AssetInfo {
                    ...
                    matrix_shards: vec![
                        MatrixShard {
                            ...
                            position: MatrixPosition { x: 3, y: 7, z: 2 },
                            size_bytes: 10485760,
                            redundancy_level: 7,
                        },
                    ],
            ...
            let response = AssetInfo {
                ...
                matrix_shards: vec![
                    ...
                    MatrixShard {
                        ...
                        position: MatrixPosition { x: 35, y: 40, z: 0 },
                        size_bytes: 4194304,
                        redundancy_level: 3,
                    },
                    MatrixShard {
                        shard_id: format!("{}_shard_3", asset_id),
                        position: MatrixPosition { x: 45, y: 50, z: 0 },
                        size_bytes: 4194304,
                        redundancy_level: 3,
                    },
                ],
        ...
        .get("/api/v1/hypermesh/nodes/health", |_req| async move {
            let nodes = vec![
                ...
                NodeHealth {
                    ...
                    last_seen: chrono::Utc::now().to_rfc3339(),
                    latency_ms: 18.3,
                    matrix_position: MatrixPosition { x: 15, y: 25, z: 1 },
                },
                NodeHealth {
                    node_id: uuid::Uuid::new_v4().to_string(),
                    ...
                    latency_ms: 145.7,
                    matrix_position: MatrixPosition { x: 30, y: 40, z: 2 },
                },
                NodeHealth {
                    node_id: uuid::Uuid::new_v4().to_string(),
                    status: "healthy".to_string(),
                    last_seen: chrono::Utc::now().to_rfc3339(),
                    latency_ms: 8.9,
                    matrix_position: MatrixPosition { x: 5, y: 15, z: 0 },
                },
            ];
