//! C Language Adapter - Clang Integration with Consensus
//!
//! This adapter provides C code compilation and execution through Clang,
...
#[async_trait]
impl LanguageRuntime for CAdapter {
    fn language_id(&self) -> &str { "c" }
    fn adapter_type(&self) -> &str { "Clang" }
