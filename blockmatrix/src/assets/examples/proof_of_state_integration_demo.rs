...
//! Proof of State Four-Proof Integration Demo
//!
//! This example demonstrates how the complete Proof of State Four-Proof system
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🔧 Proof of State Four-Proof Integration Demo");
    println!("================================================");
    ...
    // Create Proof of State Four-Proof for CPU asset allocation
    println!("\n2. Creating Proof of State Four-Proof for CPU allocation...");
    ...
    println!("\n3. Validating Proof of State Four-Proof...");
    
    // Basic validation check
    let basic_valid = state_proof.validate();
    ...
    // Create asset allocation request with state proof
    println!("\n4. Creating asset allocation request with state proof...");
    ...
    println!("   ✓ Imported complete Proof of State Four-Proof validation system");
    println!("   ✓ Replaced HyperMesh Proof of State with battle-tested Proof of State implementation");
    ...
    let state_proof_bytes = allocation_request.state_proof.to_bytes();
    println!("   Serialized state proof: {} bytes", state_proof_bytes.len());
    
    match StateProof::from_bytes(&state_proof_bytes) {
    ...
    let time_bytes = allocation_request.state_proof.time_proof.to_bytes();
