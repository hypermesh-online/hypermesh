...
impl TransportError {
    ...
    pub fn is_retryable(&self) -> bool {
        match self {
            ...
            Self::ConnectionTimeout { .. } | Self::Network(_) | Self::ResourceExhausted { .. } => {
                true
            }
            ...
            Self::NoConnection(_) | Self::ConnectionInactive(_) => true,
    ...
    E: Into<TransportError>,
{
    ...
    fn node_context(self, node_id: &PeerIdentity) -> Result<T> {
        self.map_err(|e| {
            ...
            match transport_err {
                TransportError::StoqError(err) => TransportError::StoqError(err.context(context)),
...
mod tests {
    ...
    fn test_error_categories() {
        let errors = vec![
            ...
            (
                TransportError::NoConnection("test".to_string()),
                "connection",
            ),
    ...
    fn test_retryable_errors() {
        ...
        let not_retryable = vec![
            TransportError::AuthenticationFailedWithDetails(
                PeerIdentity::from_name("test").to_string(),
                "test".to_string(),
            ),
