...
//!
//! Verifies that engauge analytics overhead fits within the R13 budget:
//! - 4 GB RAM total -> engauge should use < 256 MB
//! - 1 Mb/s network -> metrics traffic < 10 KB/s
//! - 2-core 1 GHz CPU -> engauge should use < 5% CPU
...
/// Maximum memory budget for engauge operations (256 MB).
...
/// Maximum CPU fraction for engauge operations (5%).
...
/// Profiles engauge operations against R13 minimum device spec.
///
...
impl MinSpecProfiler {
    ...
    pub fn profile_operation(
        ...
        // We assume single-threaded operation for engauge analytics.
