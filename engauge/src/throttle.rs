...
//!
//! [`EngaugeThrottle`] combines metrics and traffic classification into a
...
/// Governor feedback signal produced by engauge.
...
impl Default for EngaugeThrottle {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn fully_organic_signal() {
        let throttle = EngaugeThrottle::new();
