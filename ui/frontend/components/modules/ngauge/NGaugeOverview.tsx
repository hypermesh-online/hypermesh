...
import { useNGaugeCapacity, useNGaugeTraffic, useNGaugeThrottle } from '@/lib/hooks/useBlockMatrix';
import { Activity, Network, Cpu, HardDrive, Gauge, AlertTriangle } from 'lucide-react';
import { cn } from '@/lib/utils';

const colors = moduleColors.ngauge;

export default function NGaugeOverview() {
  const capacity = useNGaugeCapacity();
  const traffic = useNGaugeTraffic();
      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="border-red-500/30 bg-red-500/5">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-500 text-sm mt-1">Unable to reach the ngauge backend.</p>
          </CardContent>
        </Card>
      </div>
    );
