...
import NGaugeOverview from './NGaugeOverview';

const meta = {
  title: 'Pages/NGaugeOverview',
  component: NGaugeOverview,
  parameters: { layout: 'fullscreen' },
  tags: ['autodocs'],
} satisfies Meta<typeof NGaugeOverview>;
...
export const AlphaInert: Story = {
  decorators: [
    withProviders([
      ...
      [['ngauge', 'throttle'], { active: false, current_rate: 0 }],
    ]),
  ],
  parameters: {
    docs: {
      description: {
        story: 'NGauge reporting enabled but no live samples yet — all metrics at zero.',
      },
    },
  },
};
