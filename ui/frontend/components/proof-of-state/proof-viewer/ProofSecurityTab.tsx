...
function SecurityProperties() {
  const properties = [
    ...
    { label: 'Bilateral Verification', description: 'Proof has been bilaterally verified -- authentic or not, binary result.' }
  ];
...
function ThreatResistance() {
  const threats = [
    ...
    { name: 'Forgery Attack', status: 'Mitigated', color: 'yellow' }
  ];
  ...
  return (
    <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
      ...
      <p className="text-gray-300 text-sm mt-2">
        Based on cryptographic validation, bilateral verification, and threat resistance analysis.
      </p>
    </div>
  );
}
