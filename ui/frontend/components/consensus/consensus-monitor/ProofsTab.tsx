...
import type { ConsensusHealth } from './types';
    ...
    <Card className="bg-black/40 border-yellow-500/30 backdrop-blur-lg">
      ...
      <CardContent>
        <div className="grid gap-6 md:grid-cols-2">
          ...
          />
          <ConsensusControlPanel
            consensusHealth={consensusHealth}
            firstAssetId={firstAssetId}
            onValidateConsensus={onValidateConsensus}
...
function ConsensusControlPanel({
  consensusHealth,
  firstAssetId,
  onValidateConsensus,
  isValidating
