...
const defaultMetrics: ConsensusMetrics = {
  blockHeight: 15234,
  blockTime: 2.3,
  validators: 67,
  finalityTime: 4.8,
...
const defaultBlocks: ConsensusBlock[] = [
  {
    height: 15234,
  ...
  return (
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white flex items-center space-x-2">
            ...
            <span>Four-Proof Consensus System</span>
          </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-black/40 border-green-500/30 backdrop-blur-lg">
          <CardHeader>
            <CardTitle className="text-white">Consensus Performance</CardTitle>
            <CardDescription className="text-gray-400">
              Real-time consensus validation metrics
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white font-medium">{metrics.finalityTime}s</span>
              </div>
              <div className="flex justify-between text-sm">
            ...
            <div>
              <div className="text-sm font-medium text-white mb-3">Consensus Health</div>
        ...
        <Card className="bg-black/40 border-green-500/30 backdrop-blur-lg">
          <CardHeader>
            <CardTitle className="text-white">Recent Consensus Activity</CardTitle>
            <CardDescription className="text-gray-400">
