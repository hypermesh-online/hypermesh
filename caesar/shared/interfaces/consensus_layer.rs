...
pub struct ChainState {
    ...
    pub consensus_proofs: HashMap<RawAssetId, FourProof>,
}
...
pub trait ConsensusLayer {
    ...
    fn execute_vm_with_assets(&self, vm_code: &[u8], asset_resources: Vec<RawAssetId>) -> Result<ExecutionResult, ConsensusError>;
