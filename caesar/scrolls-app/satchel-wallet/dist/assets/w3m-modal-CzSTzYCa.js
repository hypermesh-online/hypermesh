import{bd as v,bf as f,bg as a,be as w,bi as d,bh as q}from"./web3-Bq1CduWo.js";import{w as ve,p as fe,s as ge,l as be,M as g,m as re,R as l,r as P,n as K,e as ce,k as le,g as m,c as Y,h as ye,o as S,E as ie,O as E,C as F,q as oe,i as T,A as H,T as xe,t as Ce,a as ke,f as Se}from"./core-C26L7qkO.js";import{c as u,U as We}from"./index-DTUFTS4a.js";import"./react-DlWwq_Dl.js";import"./query-kpRafehQ.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return be(p,()=>s(p))},subscribeKey(s,e){return ge(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
