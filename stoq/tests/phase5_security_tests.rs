...
mod quantum_crypto_tests {
    ...
    async fn test_falcon_handshake() {
        ...
        server_config.enable_falcon_crypto = true;
        ...
        let server_handle = tokio::spawn(async move {
            ...
            if let Some(falcon) = server_clone.falcon_transport() {
        ...
        client_config.enable_falcon_crypto = true;
...
mod certificate_tests {
    ...
    async fn test_self_signed_certificates() {
        ...
        let server_config = cert_manager.server_crypto_config().await.unwrap();
...
mod attack_resilience_tests {
    ...
    async fn test_dos_mitigation() {
        ...
        let mut server_config = TransportConfig::default();
        server_config.port = 0;
        server_config.max_connections = Some(10);
        server_config.max_concurrent_streams = 5;
