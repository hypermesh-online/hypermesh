...
//! behind feature gates, keeping ngauge loosely coupled from infrastructure
//! crates.
...
///
/// Implementors translate ngauge routing recommendations into eBPF policy
