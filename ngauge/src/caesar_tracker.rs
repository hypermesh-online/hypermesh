...
//! Caesar in-transit and holding amount tracking for ngauge analytics.
//!
...
/// and produces aggregated economic snapshots for ngauge analytics.
...
impl CaesarTracker {
    ...
    /// Convert to an ngauge EconomicSnapshot for streaming.
