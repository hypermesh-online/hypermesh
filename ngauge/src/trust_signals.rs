...
//!
//! NGauge already tracks per-node activity, capacity, and traffic
...
/// ngauge's existing measurement subsystems.
...
/// Coarse trust band derived from ngauge signals.
///
/// Maps directly onto `trustchain::ca::federation::FederationTrustLevel`
/// at the call site.  Kept here as an ngauge-owned enum so this crate
...
pub enum TrustBand {
    ...
    /// (ngauge itself never returns this — see
