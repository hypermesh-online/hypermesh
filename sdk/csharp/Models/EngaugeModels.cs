...
public sealed record EngaugeCapacityMetrics
{
...
public sealed record EngaugeTrafficMetrics
{
...
public sealed record EngaugeListing
{
    [JsonPropertyName("id")]
...
public sealed record EngaugeListingList
{
    [JsonPropertyName("count")]
    public int Count { get; init; }

    [JsonPropertyName("listings")]
    public List<EngaugeListing> Listings { get; init; } = [];
}

public sealed record EngaugeNodeMetrics
{
...
public sealed record EngaugeLease
{
    [JsonPropertyName("id")]
    public string Id { get; init; } = string.Empty;
...
public sealed record EngaugeLeaseList
{
    [JsonPropertyName("count")]
    public int Count { get; init; }

    [JsonPropertyName("leases")]
    public List<EngaugeLease> Leases { get; init; } = [];
}
