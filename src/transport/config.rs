...
impl HyperMeshTransportConfig {
    ...
    /// Convert to STOQ routing configuration
    pub fn to_stoq_routing_config(&self) -> stoq::routing::RoutingConfig {
        stoq::routing::RoutingConfig {
            algorithm: stoq::routing::RoutingAlgorithm::Dijkstra,
            matrix_size: 10000,
    ...
    /// Convert to STOQ chunking configuration
    pub fn to_stoq_chunking_config(&self) -> stoq::chunking::ChunkingConfig {
        stoq::chunking::ChunkingConfig {
            min_size: 16 * 1024, // 16KB
            max_size: 1024 * 1024, // 1MB
            avg_size: 64 * 1024, // 64KB
            algorithm: stoq::chunking::ChunkAlgorithm::ContentDefined,
            enable_dedup: true,
            enable_compression: true,
            compression: stoq::chunking::CompressionAlgorithm::Zstd,
            window_size: 48,
        }
    }

    /// Convert to STOQ edge configuration
    pub fn to_stoq_edge_config(&self) -> stoq::edge::EdgeConfig {
        stoq::edge::EdgeConfig {
            max_nodes: 1000,
            replication_factor: 3,
            health_check_interval: Duration::from_secs(30),
            sync_interval: Duration::from_secs(60),
            distribution_strategy: stoq::edge::DistributionStrategy::Geographic,
        }
    }
